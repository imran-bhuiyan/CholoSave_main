...
// Check if clear all notifications button was clicked
if (isset($_POST['clear_all_notifications'])) {
    ...
    $query = "UPDATE notifications SET status = 'read' WHERE target_group_id = ? AND status = 'unread'";
                    ...
                    <div class="text-center mb-12">
                        ...
                        <form method="POST" class="flex justify-center items-center space-x-4">
                            ...
                            <?php if (!empty($notifications)): ?>
                                <button type="submit" name="clear_all_notifications" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition duration-300 flex items-center">
