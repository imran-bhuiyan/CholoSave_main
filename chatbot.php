...
<<body>
    ...
    <script>
        ...
        function generateResponse(userInput) {
            ...
            if (!topic) {
                return "I apologize, but I'm not sure I understood your question. Could you please rephrase it? You can ask me about account creation, login help, groups, payments, or loans.";
            }
